...
<script>
    ...
    [@b.form name="questionForm" title="问题信息管理" action="!save" theme="list" ]
        ...
        [#else]
           [@b.textarea label="内容" required="true" check="maxLength(200)" name="question.contents" value="${(question.contents?html)!}" style="width:500px" maxlength="200" placeholder="勿包含回车等符号"/]
