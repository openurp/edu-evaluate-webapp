...
<table class="indexpanel">
    <tr>
      <td class="index_view">
        [@b.form action="!search?orderBy=supervisiorEvaluate.teacher.code asc" name="supervisiorEvaluateSearchForm" title="ui.searchForm" target="supervisiorEvaluateList" theme="search"]
            ...
            [@b.textfield style="width:100px" name="supervisiorEvaluate.teacher.code" label="工号" /]
            [@b.textfield style="width:100px" name="supervisiorEvaluate.teacher.person.name.formatedName" label="姓名" /]
