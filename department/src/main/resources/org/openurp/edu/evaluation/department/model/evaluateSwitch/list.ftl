...
[@b.grid  items=evaluateSwitches var="evaluateSwitch" sortable="false"]
  ...
  [@b.row]
    ...
    [@b.col width="10%" property="questionnaire.title" title="问卷标题"][@b.a href="!info?id=${evaluateSwitch.id!}"]${(evaluateSwitch.questionnaire.title)!}[/@][/@]
    ...
    [@b.col width="10%" property="opened" title="开关状态"]${)(evaluateSwitch.opened)?string('开','关'))!}[/@]
  [/@]
[/@]
[@b.foot/]