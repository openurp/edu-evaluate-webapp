...
import org.openurp.qos.evaluation.model.{EvaluationCriteriaItem, Option, Question, QuestionType, Questionnaire}
...
class ClazzEvalStatAction extends ProjectRestfulAction[ClazzEvalStat] {
  ...
  def departmentChoiceConfig(): View = {
    ...
    //    " org.openurp.qos.evaluation.clazz.stat.model.ClazzEvalStat evaluateR "  +
