...
import org.openurp.qos.evaluation.clazz.result.model.QuestionResult
import org.openurp.qos.evaluation.clazz.stat.model._
import org.openurp.qos.evaluation.model.{Option, Question, QuestionType, Questionnaire}
...
class DepartEvalStatAction extends ProjectRestfulAction[DepartEvalStat] {
  ...
  def stat(): View = {
    ...
    //    " from  org.openurp.qos.evaluation.clazz.result.model.QuestionResult qR "+
