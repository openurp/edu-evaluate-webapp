...
<BODY onblur="self.focus();" LEFTMARGIN="0" TOPMARGIN="0" onload="mergeTableTd('tableName',1)">
    ...
    <@table.table id="tableName" width="100%">
           <@table.thead>
             <@table.td text="&nbsp;"/>
             <@table.td name="field.question.indicator"/>
          ...
          <@table.tbody datas=questions;question>
           ...
           <tr class="darkColumn" align="center">
               <td colspan="5" align="center"><button name="button1" value="" class="buttonStyle" onClick="doSubmit()"><@text name="action.confirm"/></button>
               </td>
           </tr>
    </@>
