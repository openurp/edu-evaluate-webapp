...
<div class="search-container">
    <div class="search-panel">
        [@b.form action="!search?orderBy=courseEvalStat.score desc" name="courseEvalStatIndexForm" title="ui.searchForm" target="contentDiv" theme="search"]
            ...
            [@b.textfields names="courseEvalStat.crn;课程序号,courseEvalStat.course.code;课程代码,courseEvalStat.course.name;课程名称,courseEvalStat.teacher.user.code;教师工号,courseEvalStat.teacher.user.name;教师姓名"/]
    ...
    <div class="search-list">
            [@b.div id="contentDiv" href="!search?orderBy=courseEvalStat.departRank&courseEvalStat.semester.id="+currentSemester.id/]
    </div>
</div>
[@b.foot/]
