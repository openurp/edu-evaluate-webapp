...
[@b.head/]
    [@b.grid items=courseEvalStats var="courseEvalStat" sortable="true"]
      [@b.gridbar]
        ...
        "category.name:课程分类,teacher.user.code:教师工号,teacher.user.name:教师姓名,grade.name:档次,tickets:参评人数,categoryRank:分类排名,departRank:开课院系排名,schoolRank:全校排名,"+
      ...
      [/@]
        [@b.row]
            ...
            [@b.col property="category.name" title="课程分类" width="15%"]
              ...
              [/#if]
            [/@]
            [@b.col property="teacher.user.name" title="教师姓名" width="13%"]
