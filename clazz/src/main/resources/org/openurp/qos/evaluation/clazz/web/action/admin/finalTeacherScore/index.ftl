...
<div class="search-container">
  <div class="search-panel">
        [@b.form action="!search" name="finalTeacherScoreIndexForm" title="ui.searchForm" target="contentDiv" theme="search"]
         ...
         [@b.select style="width:134px" name="finalTeacherScore.teacher.user.department.id" label="教师所属院系" items=departments empty="..."/]
         [@b.textfield style="width:100px" name="finalTeacherScore.teacher.user.code" label="教师工号" /]
         [@b.textfield style="width:100px" name="finalTeacherScore.teacher.user.name" label="教师姓名" /]
         [/@]
  </div>
