...
<table width="100%"class="frameTable">
    ...
    <table width="100%" class="searchTable">
        ...
        <input type="hidden" name="keys" value="depart.name,teacher.user.department.name,teacher.user.code,teacher.name,teacher.teacherType.name,course.code,taskSeqNo,course.name,validTickets,<#list questionTypeList?if_exists as questionType>questionTypeStat_${questionType.id},</#list>scoreDisplay,semester.schoolYear,semester.name">
        </form>
        </td>
        <td valign="top">
