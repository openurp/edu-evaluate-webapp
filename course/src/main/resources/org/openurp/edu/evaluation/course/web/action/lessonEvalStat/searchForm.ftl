...
<table class="indexpanel">
    <tr>
        ...
        [@b.form action="!search" name="evaluateTeacherStatIndexForm" title="ui.searchForm" target="contentDiv" theme="search"]
            ...
            [@b.textfields style="width:130px" names="lessonEvalStat.lesson.no;课程序号,lessonEvalStat.lesson.course.code;课程代码,lessonEvalStat.lesson.course.name;课程名称,lessonEvalStat.teacher.user.code;教师工号,lessonEvalStat.teacher.user.name;教师姓名"/]
