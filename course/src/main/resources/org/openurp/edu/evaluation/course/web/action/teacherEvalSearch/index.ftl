...
<table class="indexpanel">
    ...
    <td class="index_view">
       ...
       [@b.textfield style="width:100px" name="teacherEvalStat.teacher.code" label="教师工号" /]
       [@b.textfield style="width:100px" name="teacherEvalStat.teacher.person.name.formatedName" label="教师姓名" /]
