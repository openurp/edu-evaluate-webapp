...
<table width="95%">
         <tr>
         <td  colspan="${((questionnaires.questions?size)+5)}" align="center" ><b>${semester.schoolYear!}(${semester.name!}) 评教汇总</b></td>
        </tr>
        <tr>
        <td  colspan="${((questionnaires.questions?size)+5)}" align="left" ><b>学校总分加权平均分：${evaluateResults!0}</b></td>
        </tr>
</table>
<table class="planTable" width="95%">
     <tr align="center" class="darkColumn">
       ...
       <td rowspan="2">人次</td>
       <td colspan="${((questionnaires.questions?size))}" align="center">各项得分</td>
      <td rowspan="2">总分</td>
     </tr>
