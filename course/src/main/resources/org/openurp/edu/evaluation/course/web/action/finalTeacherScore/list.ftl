...
[@b.form name="finalTeacherScoreSearchForm" action="!search" target="contentDiv"]    <table id="bar" width="100%"></table>
    ...
    [@b.grid items=finalTeacherScores var="finalTeacherScore" sortable="true"]    
        ...
        [@b.row]
            [@b.boxcol/]
            [@b.col  property="staff.state.department.name" title="教师所属部门" width="20%"/]
...
<script>
 ...
 function exportData(){
      ...
      bg.form.addInput(form,"keys","staff.code,staff.name,staff.state.department.name,semester.code,stdScore,supviScore,departScore,score,rank");
