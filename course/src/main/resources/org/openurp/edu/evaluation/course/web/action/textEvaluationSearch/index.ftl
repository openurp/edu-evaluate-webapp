...
<table class="indexpanel">
    <tr>
        ...
        [@b.form action="!search" name="textEvaluationIndexForm" title="ui.searchForm" target="contentDiv" theme="search"]
            ...
            [@b.textfields style="width:130px" names="textEvaluation.lesson.no;课程序号,textEvaluation.lesson.course.name;课程名称,textEvaluation.staff.code;教师工号,textEvaluation.staff.person.name.formatedName;教师姓名"/]
            [@b.select style="width:134px" name="textEvaluation.lesson.teachDepart.id" label="开课院系" items=departments empty="..."/]
            [@b.select style="width:134px" name="textEvaluation.state" label="是否确认" items={'1':'是','0':'否'} empty="..."/]
        [/@]
        </td>
