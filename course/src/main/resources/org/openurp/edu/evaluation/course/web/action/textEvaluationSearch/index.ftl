...
<table class="indexpanel">
    <tr>
        ...
        [@b.form action="!search" name="textEvaluationIndexForm" title="ui.searchForm" target="contentDiv" theme="search"]
            ...
            [@b.textfields style="width:130px" names="textEvaluation.lesson.no;课程序号,textEvaluation.lesson.course.code;课程代码,textEvaluation.lesson.course.name;课程名称,textEvaluation.teacher.user.code;教师工号,textEvaluation.teacher.user.name;教师姓名"/]
