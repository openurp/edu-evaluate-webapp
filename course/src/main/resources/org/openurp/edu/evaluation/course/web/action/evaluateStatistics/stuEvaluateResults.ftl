...
[/@]
[@b.row]
        [@b.col width="4%" title="课程序号"]${(evaluateR.lesson.no)?if_exists}[/@]
        [@b.col width="4%" title="课程代码"]${(evaluateR.lesson.course.code)?if_exists}[/@]
        [@b.col width="8%" title="课程名称"]${(evaluateR.lesson.course.name)?if_exists}[/@]
