...
<script type="text/javaScript">
    ...
    function exportData() {
            ...
            bg.form.addInput(form, "keys", "lesson.no,lesson.course.name,staff.person.name.formatedName,evaluateByTeacher,content,semester.schoolYear,semester.name,state");
